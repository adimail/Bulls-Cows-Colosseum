...
export default function SpectatePage() {
  ...
  return (
    <div className="min-h-screen bg-dark-stone text-parchment font-roman p-4">
      <header className="flex justify-between items-center mb-8 border-b border-bronze/20 pb-4">
        <div>
          <h1 className="text-2xl font-cinzel text-stone-light">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-dark-card p-6 border border-bronze/30">
          <h3 className="text-xl font-cinzel text-bronze mb-2">
            {gameState.p1.name}
          </h3>
          <div className="mb-4 text-3xl font-nums tracking-widest text-center bg-dark-stone p-4 border border-bronze/30">
      ...
      {gameState.status === "completed" && (
        <div className="mt-8 text-center">
          <h2 className="text-4xl font-cinzel text-bronze">
            Winner:{" "}
